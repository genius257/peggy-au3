...
class Peggyau3 implements IPeggyau3 {
    ...
    generate(ast: ast.Grammar, options: ParserBuildOptions, session: Session): void {
        ...
        this.parts.push([
            ...
            `EndFunc`,
            `Func ${this.functionName("Parser_ZeroOrMore")}($t, $v)`,
                `Local $a[16], $i = 0, $p = ${this.functionName("InputStream_GetPosition")}($t), $e = 0, $s`,
                `While 1`,
            ...
            `Func ${this.functionName("Parser_Group")}($t, $a, $i = Null)`,
                ...
                `Return SetError($e, $p, $r)`,
            `EndFunc`,
            `Func ${this.functionName("Parser_Class")}($t, $a, $b = True, $inv = False)`,
                `Local $a2`,
            ...
            `Func ${this.functionName("Parser_Named")}($t, $n, $a)`,
                ...
                `Return SetError(@error, @extended, $r)`,
            `EndFunc`,
            `Func ${this.functionName("Parser_Text")}($t, $a)`,
                `Local $p = ${this.functionName("InputStream_GetPosition")}($t)`,
                `Local $r = ${this.functionName("Parser_Run")}($t, $a)`,
            ...
            `EndFunc`,
            `Func ${this.functionName("Parser_Optional")}($t, $a)`,
                // `Local $e = 0`,
                `Local $p = ${this.functionName("InputStream_GetPosition")}($t)`,
                `Local $r = ${this.functionName("Parser_Run")}($t, $a)`,
                `If @error Then`,
